...
public abstract class Command
{
    ...
    public static void sendClientMessage(final String message) {
        if (Command.MsgWaterMark) {
            Command.mc.player.sendMessage((ITextComponent)new TextComponentString(ChatFormatting.DARK_GRAY + "[" + ChatFormatting.AQUA + "Aurora" + ChatFormatting.DARK_GRAY + "] " + message));
        }
        else {
