...
public class Module
{
    ...
    public void enable() {
        ...
        if (ModuleManager.isModuleEnabled("ToggleMsgs") && !this.getName().equalsIgnoreCase("ClickGUI")) {
            Wrapper.sendClientMessage(ChatFormatting.LIGHT_PURPLE + this.getName() + ChatFormatting.GREEN + " Enabled.");
        }
        this.onEnable();
    }
    ...
    public void disable() {
        ...
        if (ModuleManager.isModuleEnabled("ToggleMsgs") && !this.getName().equalsIgnoreCase("ClickGUI")) {
            Wrapper.sendClientMessage(ChatFormatting.LIGHT_PURPLE + this.getName() + ChatFormatting.RED + " Disabled.");
        }
        this.onDisable();
